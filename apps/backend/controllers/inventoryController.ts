import { Inventory, Room, Label, MaintenanceLog, User } from '../models';
...
export const getInventory = asyncHandler(async (req: any, res: any) => {
  ...
  if (month && month !== 'all') {
    where[Op.and] = where[Op.and] || [];
    where[Op.and].push(
      sequelize.where(sequelize.fn('MONTH', sequelize.col('acquired_date')), month)
    );
  }
...
export const getInventoryDetail = asyncHandler(async (req: any, res: any) => {
...
export const createInventory = asyncHandler(async (req: any, res: any) => {
...
export const updateInventory = asyncHandler(async (req: any, res: any) => {
  const t = await sequelize.transaction();
  try {
...
export const updateLabel = asyncHandler(async (req: any, res: any) => {
...
export const getLabels = asyncHandler(async (req: any, res: any) => {
...
export const deleteInventory = asyncHandler(async (req: any, res: any) => {
...
export const restoreInventory = asyncHandler(async (req: any, res: any) => {
