  ...
  async function handleSubmit(e: any) {
    ...
    try {
      const payload = {
        ...
        room_id: form.room_id ? parseInt(String(form.room_id)) : null,
      };
  ...
  return (
    <>
        ...
        <form id="new-inv-form" onSubmit={handleSubmit} className="flex-col gap-4">
          <div className="field">
            <div className="field-lbl">
              Kode Barcode / QR Manual <span className="req">*</span>
            </div>
            <p className="text-xs text-ink-3 mb-2 leading-relaxed">
              Pindai atau ketik nomor seri barcode kampus secara manual (contoh: LK-001).
            </p>
            <input
      ...
      <div className="drawer-foot">
        <button type="button" className="btn" onClick={() => dispatch({ type: 'CLOSE_DRAWER' })}>
          Batal
        </button>
