...
function Icon({ name, size = 16, strokeWidth = 1.6, ...rest }) {
  const paths = {
    ...
    users:   <><circle cx="9" cy="8" r="3.5"/><path d="M3 21c0-3.5 2.5-6 6-6s6 2.5 6 6M16 4a3 3 0 010 6M19 21c0-2.5-1-4.5-3-5.5"/></>,
    room:    <><path d="M3 9.5L12 4l9 5.5M5 10v9h14v-9M9 19v-5h6v5"/></>,
    log:     <><path d="M9 3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V5a2 2 0 00-2-2h-4M9 3v4h6V3M8 11h8M8 15h5"/></>,
    cart:    <><circle cx="9" cy="20" r="1.5"/><circle cx="18" cy="20" r="1.5"/><path d="M3 4h2l2.5 12h12l2.5-9H7"/></>,
    box:     <><path d="M21 8L12 3 3 8m18 0v8l-9 5-9-5V8m18 0l-9 5m0 0L3 8m9 5v8"/></>,
    flask:   <><path d="M9 3v6l-5 9a3 3 0 003 3h10a3 3 0 003-3l-5-9V3M9 3h6M7 14h10"/></>,
    check:   <><path d="M9 12l2 2 4-4m-9 6V6a2 2 0 012-2h10a2 2 0 012 2v10a2 2 0 01-2 2H8l-3 3v-3z"/></>,
    history: <><path d="M3 12a9 9 0 109-9 9.7 9.7 0 00-6.74 2.74L3 8M3 3v5h5M12 7v5l4 2"/></>,
    truck:   <><rect x="1" y="6" width="14" height="11" rx="1.5"/><path d="M15 9h4l3 3v5h-7M5.5 21a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm12 0a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"/></>,
    qr:      <><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="3" height="3"/><rect x="8" y="14" width="2" height="2"/><rect x="14" y="14" width="2" height="2"/></>,
    wrench:  <><path d="M14.7 6.3a4 4 0 01-5.4 5.4L4 17l3 3 5.3-5.3a4 4 0 015.4-5.4L15 12l-2-2 1.7-3.7z"/></>,
