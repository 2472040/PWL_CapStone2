...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      <div className="sb-sec" data-sb-anim>
        Menu
      </div>
        ...
        {items.map((it) => {
          ...
          return (
            ...
            >
              ...
              {badgeValue ? (
                <span className={`badge ${typeof badgeValue === 'number' ? 'num' : 'new'}`}>
                  {badgeValue}
                </span>
              ) : null}
            </div>
      ...
      <div className="sb-foot" data-sb-anim>
        <div className="sb-foot-actions" role="group" aria-label="Aksi cepat">
          ...
          <button
            ...
            onClick={(e) => themeTransition(dispatch, state.theme === 'dark' ? 'light' : 'dark', e)}
          >
            {state.theme === 'dark' ? (
              <svg
                width="15"
        ...
        <div className="sb-foot-card">
          ...
          <div>
            ...
            <div className="mono text-[10px] mt-0.5">
              {state.rooms.length || 9} lab · {state.inventory.length || 287} aset · live
            </div>
          </div>
        </div>
      </div>
