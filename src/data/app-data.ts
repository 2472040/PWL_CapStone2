...
const maintLog = [
  {
    ...
    name: 'Oscilloscope Rigol DS1054Z',
    date: '18 Mei 2026',
    tech: 'Maharani Larasati',
    action: 'Kalibrasi & cleaning probe',
    cond: 'Maintenance',
    bhp: [{ id: 'B-009', qty: 0.15, unit: 'btl' }],
  },
  {
    id: 'M-2026-013',
    asset: 'LK-SW-014',
  ...
  },
  {
    ...
    cond: 'Baik',
    bhp: [
      { id: 'B-003', qty: 1, unit: 'tube' },
      { id: 'B-009', qty: 0.05, unit: 'btl' },
    ],
  },
];
