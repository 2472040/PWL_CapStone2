...
const testimonialsData = [
  {
    ...
    quote: "Sistem pengadaan sebelumnya sangat berantakan. Dengan Loka Lab Suite, proses approval jauh lebih cepat dan transparan.",
  ...
  },
  {
    ...
    quote: "Stok BHP berkurang otomatis tiap kali ada praktikum. Saya tidak perlu lagi hitung manual tiap akhir bulan.",
    name: 'Budi Santoso',
  ...
  },
  {
    ...
    quote: "Kartu aset digital dengan QR code sangat memudahkan pelacakan kondisi alat. Cukup scan, semua riwayat muncul.",
    name: 'Nadia Putri',
    ...
    <section className="py-24 relative overflow-hidden" id="testimonials">
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <div className="au-section-tag justify-center"><ScrambleText text="— Apa Kata Mereka" /></div>
          <h2 className="text-3xl md:text-5xl font-semibold tracking-tight text-white mb-4">Dipercaya oleh institusi top.</h2>
          <p className="text-[#a1a1aa] max-w-2xl mx-auto">Kami mendengarkan masalah di lapangan dan membangun solusi yang benar-benar menjawab kebutuhan staf laboratorium.</p>
        </div>
              ...
              >
                <div className="flex flex-col md:flex-row items-center justify-center w-full p-4">
                  ...
                  <div className="relative w-full bg-[#18181b] border border-[#27272a] text-white rounded-2xl shadow-xl pt-10 md:pt-6 pl-6 md:pl-20 pr-6 pb-6">
                     <Quote className="absolute top-6 left-6 md:left-12 h-10 w-10 text-white/10" aria-hidden="true" />
