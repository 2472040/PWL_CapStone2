...
const MicrosoftIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23 23" fill="currentColor" className="w-12 h-12 text-white">
...
const VercelIcon = () => (
  <svg viewBox="0 0 256 222" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-12 h-12 text-white">
    <path d="m128 0 128 221.705H0z"/>
  </svg>
);

const ReactIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="-11.5 -10.232 23 20.463" fill="currentColor" className="w-12 h-12 text-white">
    <circle r="2.05"/>
...
const partners = [
  { icon: GithubIcon, name: 'GitHub', gradient: { from: '#333333', via: '#555555', to: '#111111' } },
  { icon: MicrosoftIcon, name: 'Microsoft', gradient: { from: '#00A4EF', via: '#7FBA00', to: '#F25022' } },
  { icon: VercelIcon, name: 'Vercel', gradient: { from: '#000000', via: '#333333', to: '#000000' } },
  { icon: ReactIcon, name: 'React', gradient: { from: '#61DAFB', via: '#282C34', to: '#20232A' } },
  { icon: NodeIcon, name: 'Node.js', gradient: { from: '#339933', via: '#66CC33', to: '#006600' } },
];
...
export default function AdvancedMarquee() {
  return (
    <>
      ...
      <section className="w-full bg-transparent overflow-hidden py-16 border-y border-white/5">
        <div className="w-full overflow-hidden" style={{ maskImage: 'linear-gradient(to right, transparent, black 10%, black 90%, transparent)' }}>
          ...
          >
            {/* Render 4 sets of logos for infinite loop */}
            {[...partners, ...partners, ...partners, ...partners].map((logo, index) => (
              <div
                key={index}
                className="group relative h-24 w-48 shrink-0 flex items-center justify-center rounded-xl bg-white/5 overflow-hidden transition-transform duration-300 hover:scale-105 border border-white/5 hover:border-white/20"
              >
