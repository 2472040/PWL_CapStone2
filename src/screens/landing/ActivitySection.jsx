  ...
  return (
    <section className="au-section" style={{ paddingTop: 0 }} id="activity-feed">
      <div className="grid grid-cols-1 md:grid-cols-[1fr_1.4fr] gap-12 items-start">
        <AuRise>
          <div className="au-section-tag"><ScrambleText text="— Aktivitas tim" /></div>
          <h2 className="text-3xl md:text-5xl font-semibold tracking-tight text-white mb-6">Riwayat yang <em>jujur</em> — siapa, kapan, untuk apa.</h2>
          <p className="text-[#a1a1aa] text-lg">Setiap aksi tercatat dengan jejak yang bisa diaudit. Tidak ada perubahan diam-diam.</p>
        </AuRise>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-sm text-gray-300 truncate">
                      <b className="text-white">{a.who}</b> <span className="px-2 py-0.5 rounded-full bg-white/10 text-xs text-white/70 mx-1">{a.role}</span> {a.act} <span className="font-mono text-[#6366F1]">{a.target}</span>
                    </div>
                  </div>
