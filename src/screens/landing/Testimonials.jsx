...
export default function Testimonials() {
  ...
  return (
    <section className="au-section" id="testimonials-section">
      <div className="au-section-tag"><ScrambleText text="— Testimoni" /></div>
      <h2 className="au-section-h2">Apa kata mereka yang sudah <em>merasakan</em> bedanya.</h2>
      ...
      <div className="au-testimonial-card">
        ...
        <div className="au-testimonial-quote">
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" style={{ color: t.accentColor, opacity: 0.4, marginBottom: 16 }}>
            <path d="M3 21c3 0 7-1 7-8V5c0-1.25-.756-2.017-2-2H4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2 1 0 1 0 1 1v1c0 1-1 2-2 2s-1 .008-1 1.031V20c0 1 0 1 1 1z" fill="currentColor"/>
            <path d="M15 21c3 0 7-1 7-8V5c0-1.25-.757-2.017-2-2h-4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2h.75c0 2.25.25 4-2.75 4v3c0 1 0 1 1 1z" fill="currentColor"/>
          </svg>
          <p className="au-testimonial-text" key={active}>{t.text}</p>
        </div>

        <div className="au-testimonial-author">
          <div className="au-testimonial-avatar" style={{ 
