...
function BentoCard({ f }) {
  ...
  return (
    <div ref={cardRef} className="au-bento-item group relative transition-transform duration-200 ease-out will-change-transform">
      ...
      {/* Existing Glow */}
      <div className="au-bento-glow transition-opacity duration-300 group-hover:opacity-60" style={{ background: f.glowColor }} />
      
      <div className="relative z-10 pointer-events-none">
        <div className="au-bento-icon transition-transform duration-300 group-hover:scale-110 group-hover:-translate-y-1" style={{ color: f.glowColor }}>{f.icon}</div>
...
export default function BentoFeatures() {
  return (
    <section className="au-bento-section" id="bento-features">
      <div className="au-section-tag"><ScrambleText text="— Fitur Unggulan" /></div>
      <h2 className="au-section-h2">Satu platform, <em>segala kebutuhan</em> laboratorium Anda.</h2>
      <p className="au-section-sub">Dari aset fisik hingga bahan habis pakai, dari pengadaan hingga audit — semua terhubung dalam satu ekosistem.</p>
