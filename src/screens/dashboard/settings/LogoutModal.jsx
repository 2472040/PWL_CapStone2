  ...
  return (
    <>
      <div className="text-center animate-fade-in" style={{ padding: '24px 24px 18px' }}>
        <div
          className="text-rose h-14 w-14 animate-pulse-slow"
          style={{
            borderRadius: '50%',
            background: 'rgba(255,107,131,0.15)',
            display: 'flex',
            alignItems: 'center',
        ...
        <div className="text-sm text-ink-3 leading-[1.5] max-w-[320px] mx-auto">
          Kamu akan keluar sebagai <b style={{ color: 'var(--color-ink)' }}>{me.name}</b>. Draf yang
          sedang dibuat tetap tersimpan.
        </div>
      </div>
      <div
        className=""
      ...
      >
        <button className="btn flex-1 justify-center" onClick={close}>
          Batal
        </button>
        <button className="btn danger flex-1 justify-center" onClick={logout}>
          Ya, keluar
        </button>
      </div>
    </>
