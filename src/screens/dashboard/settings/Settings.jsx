    ...
    <div className="page max-w-[920px]" >
      <div className="page-head" data-reveal>
        <div>
          ...
          <p className="page-sub">Sesuaikan tampilan, akun, dan preferensi Loka untuk role <b>{role ? role.short : ''}</b>.</p>
        </div>
      </div>
      ...
      <SettingsSection title="Akun" sub={`${me.name} · ${me.email}`} reveal>
        ...
        <SettingsRow label="Password" desc="Amankan akun Anda dengan password baru.">
          <button className="btn" onClick={() => dispatch({ type: 'OPEN_MODAL', modal: { kind: 'changePassword' } })}>Ubah password</button>
        </SettingsRow>
