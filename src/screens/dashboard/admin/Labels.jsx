    ...
    <div className="page" style={{'--role-accent': role.accent}}>
      <div className="page-head" data-reveal>
        <div>
          ...
          <p className="page-sub">Generate QR internal & foto QR Universitas untuk aset yang baru diterima.</p>
        </div>
      ...
      <div data-reveal className="gap-3" style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(350px, 1fr))'}}>
        {recent.map(it => (
          <div key={it.code} className="card p-4 flex flex-col justify-between" >
            <div className="flex justify-center gap-6 mb-4">
              <div className="flex flex-col items-center">
                <div className="text-[10px] text-ink-3 uppercase mb-2 font-semibold tracking-wider">QR Internal</div>
                <QR seed={it.code} size={8} />
              </div>
              {it.photoUrl && (
                <div className="flex flex-col items-center">
                  <div className="text-[10px] text-ink-3 uppercase mb-2 font-semibold tracking-wider">QR Universitas</div>
                  <img src={it.photoUrl} alt="QR Univ" style={{width: 128, height: 128, objectFit: 'contain', background: '#fff', padding: 4, borderRadius: 8}} />
                </div>
              )}
            </div>
            ...
            <div className="flex gap-2 mt-auto">
              ...
              {it.photoUrl && (
                <button className="btn sm flex-1 justify-center" onClick={() => {
