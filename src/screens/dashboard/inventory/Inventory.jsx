...
export function Inventory() {
  ...
  const generateInventoryPDF = () => {
      ...
      content: [
        ...
        // Totals
        {
          columns: [
            ...
            { text: `Total Nilai Valuasi: Rp ${totalValuation.toLocaleString('id-ID')}`, style: 'totalValuation', width: 250 }
          ]
        },
        { text: '\n\n' },
    ...
    pdfMake.createPdf(docDefinition).download(`Laporan_Inventaris_${new Date().toISOString().substring(0, 10)}.pdf`);
