...
Kami menggunakan alur kerja berbasis fitur (_Feature Branch Workflow_). Semua pengembangan baru harus dibuat di branch terpisah dan digabungkan melalui _Pull Request_ (PR) ke branch `main`.
...
3. PR Anda harus ditinjau dan disetujui (_Approved_) oleh minimal **2 kontributor inti** sebelum dapat di-merge.
4. Semua pengecekan otomatis (jika ada CI/CD) harus berstatus hijau (_green_).
