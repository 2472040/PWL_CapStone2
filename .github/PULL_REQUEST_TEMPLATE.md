...
- [ ] Tidak ada berkas rahasia (`.env`, kunci enkripsi privat) yang tidak sengaja terdorong (*pushed*) ke repositori.
- [ ] Skema database baru (jika ada) telah dilengkapi dengan migration/seeder yang sesuai.
- [ ] Tidak ada *linter warnings* baru di sisi frontend maupun backend.
